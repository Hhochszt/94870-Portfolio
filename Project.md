...
## Part III
The final step in my project was implementation. This meant generating graphics from the data, seeing what the data said and using that to write an article. The synagogue map and Jewish Day School Enrollment graphs both yielded the expected information - Jews do in fact tend to live in the cities. However when I looked at the political data, the story became more complicated. Initially I misread the data and beleived that the American Jews are more liberal than their resident states, However, the data implies exactly the opposite! This changed my story, because it showed that politics has very little to do with where American Jews live. I also removed my section on diversity, based on the previous feedback that implied it would be unneccessary and could not prove much. This left a larger section explaining the practicalities of Judaism and why they necessitate an urban community. For this section I was largely unable to find any form of standardized data. Instead, I used a case study, citing statistics and historical facts from Squirrel Hill, to explain both the effects of historical events, and the snowball effect that causes Jewish communities to grow. Finally, I presented a call to action: to learn more about Judaism. I explained that the article is incomplete without pursuing further explanation about how Jews live and why they choose to do so. Initially I had planned to write articles explaining certain aspects of Judaism, but I discovered that there are many in-depth resources available already online. Rather than write my own material, I linked to specific entries on their websites, with hope that readers would look at those pages and choose to read even more on their own.
Please enjoy my article: [Why Jews Live in New York: The Downfall of Rural Judaism](https://carnegiemellon.shorthandstories.com/why-jews-live-in-new-york/index.html)
